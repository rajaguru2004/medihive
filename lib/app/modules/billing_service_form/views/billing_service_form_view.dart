...
class BillingServiceFormView extends GetView<BillingServiceFormController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: DetailHeader(
        title: form.isEdit ? 'Edit service' : 'Add service',
      ),
      body: BentoGround(
        child: SafeArea(
          child: Form(
        ...
        children: [
          ...
          Obx(
            () => AsyncPicker<String>(
              ...
              options: [
                for (final category
                    in BillingServiceFormController.categories)
                  PickerOption<String>(
                    value: category,
          ...
          Obx(
            () => !form.isCoveredByInsurance.value
                ...
                : BentoInput(
                    ...
                    placeholder: '0',
                    hint: 'The share the patient pays. Leave it empty if there '
                        'is none.',
                    keyboardType:
                        const TextInputType.numberWithOptions(decimal: true),
                    inputFormatters: [
          ...
          Obx(
            () => !form.isEdit
                ...
                : BentoSwitchRow(
                    ...
                    sublabel: 'Off takes it out of the catalogue. Invoices '
