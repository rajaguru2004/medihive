...
class HomeView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      final index = controller.selectedNavIndex;
      return Scaffold(
        backgroundColor: bg,
        appBar: index == 0 ? _buildAppBar(context, isDark) : null,
        body: _buildBody(context, isDark, index),
        bottomNavigationBar: const _BottomNav(),
      );
    });
  }

  Widget _buildBody(BuildContext context, bool isDark, int index) {
    switch (index) {
      case 0:
          ...
          child: ListView(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(child: _AppointmentBreakdownCard(isDark: isDark)),
                ],
              ),
      ...
      case 1:
        return const AppointmentsView(isEmbedded: true);
      case 2:
        return const InpatientView(isEmbedded: true);
      case 3:
        return const QueueView(isEmbedded: true);
      default:
    ...
    return Obx(() {
      ...
      final cards = [
        ...
        _StatCardData(
          ...
          statusType: s.pendingPrescriptions > 0
              ? StatusType.warning
              : StatusType.success,
        ),
      ];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Spacer(),
          Text(data.value, style: AppTextStyles.headlineSmall(textPrimary)),
...
class _AppointmentBreakdownCard extends GetView<HomeController> {
  ...
  List<PieChartSectionData> _buildSections(List<_PieSegment> segs, int total) {
    return segs
        .where((s) => s.count > 0)
        .map(
    ...
    return Stack(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            Text('$total', style: AppTextStyles.headlineSmall(textPrimary)),
            Text('Total Slots', style: AppTextStyles.labelSmall(textSecondary)),
          ],
        ),
      ],
    );
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: AppSpacing.sm),
          Expanded(
            child: Text(label, style: AppTextStyles.bodySmall(textPrimary)),
          ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Active waiting time by department',
                        style: AppTextStyles.bodySmall(textSecondary),
                      ),
                    ],
                  ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Latest admissions & registrations',
                        style: AppTextStyles.bodySmall(textSecondary),
                      ),
                    ],
                  ),
        ...
        child: Column(
          ...
          children: [
            ...
            if (appointments.isEmpty)
              ...
              ...appointments.map(
                (a) => _AppointmentRow(appointment: a, isDark: isDark),
              ),
          ],
        ),
      );
